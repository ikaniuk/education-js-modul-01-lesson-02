...
// do {
//     value = Number(prompt(`Введи число больше ${number}`));
// } while (value <= number);
...
// Задание:
// Запросите у пользователя число, посчитайте сумму всех числе между 0 и введенным
// значением и отобразите результат на экран.
...
// console.log(`Сумма чисел от 0 до ${userNumber} =`, total);
